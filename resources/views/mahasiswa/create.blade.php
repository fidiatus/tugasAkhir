...
<div class="container">
  <div class="row">
      ...
      <div class="panel panel-default">
          <div class="panel-heading"><h4>Create New Mahasiswa </h4></div>
          
        <div class="panel-body">
          <div class="panel-body">
              <a class="btn btn-primary" href="{{ route('mahasiswa.index') }}"> Back</a>
          </div>
  {!! Form::open(array('route' => 'mahasiswa.store','method'=>'POST')) !!}
      <div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            {!! Form::text('no_hp', null, array('placeholder' => 'Handphone','class' => 'form-control')) !!}
                @if ($errors->has('no_hp'))
                    <span class="help-block">
